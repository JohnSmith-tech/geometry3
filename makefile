...
$(DIR_BIN)/main: $(DIR_BUILD)/main.o $(DIR_BUILD)/Figure.o $(DIR_BUILD)/Intersection.o
	g++ -Wall -o $(DIR_BIN)/main $(DIR_BUILD)/main.o $(DIR_BUILD)/Figure.o $(DIR_BUILD)/Intersection.o
